...
namespace Drupal\simplenews\Drush\Commands;
...
class SimplenewsCommands extends DrushCommands {
   ...
   *   The config factory.
   * @param \Drupal\simplenews\Spool\SpoolStorageInterface $spoolStorage
   *   The spool storage.
  ...
  public function __construct(
    ...
    protected readonly SpoolStorageInterface $spoolStorage,
