...
class __TwigTemplate_e78a4827e8144d0dd0820d7add0d3340 extends Template
{
...
<p>{% trans %}The core User module allows users to register, log in, and log out, and administrators to manage user roles and permissions. The core Ban module allows administrators to ban certain IP addresses from accessing the site. Depending on which modules you have installed on your site, the related topics below will help you with tasks related to managing user accounts and visitors.{% endtrans %}</p>", "@help_topics/user.overview.html.twig", "/var/www/drupal/drupal_news_blog/web/core/modules/user/help_topics/user.overview.html.twig");
    }
